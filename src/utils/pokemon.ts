...
export const uiTranslations: Record<string, Record<string, string>> = {
    es: {
        ...
        'desc_subtitle': 'Pokémon, movimientos, habilidades, objetos, evoluciones, formas, generaciones y datos de juego, conectados y fáciles de consultar.',
        ...
        'item_effect_label': 'Efecto / Mecánica',
        'item_flavor_label': 'Descripción en el juego',
        'item_no_effect_available': 'Efecto detallado no disponible.',
        'item_effect_en_fallback': 'PokeAPI no ofrece este texto en español; se muestra en el idioma original.',
        'items': 'Objetos',
        ...
        'sources_intro_body': 'Pokepedia es un proyecto independiente que reúne datos factuales de Pokémon (especies, movimientos, habilidades, objetos y generaciones) en un solo sitio. No está afiliado ni respaldado por Nintendo, Game Freak, The Pokémon Company ni Smogon University.',
        ...
        'sources_data_smogon': 'Tier de Smogon de cada Pokémon, como dato de referencia, obtenido de los datos públicos de Pokémon Showdown.',
        ...
        'source_competitive': 'Fuente: Smogon (vía Pokémon Showdown)',
        'tier_title': 'Tier de Smogon',
        'view_on_pokestudio': 'Ver sets y estrategia en PokeStudio',
        'view_types_on_poketypes': 'Debilidades en PokeTypes',
        ...
        'moves_title_seo': 'Pokémon Moves',
        'moves_desc_seo': 'Check the technical database of all Pokémon attacks.',
        'abilities_title_seo': 'Pokémon Abilities',
        ...
        'desc_subtitle': 'Pokémon, moves, abilities, items, evolutions, forms, generations and game data, connected and easy to look up.',
        ...
        'item_effect_label': 'Effect / Mechanics',
        'item_flavor_label': 'In-game description',
        'item_no_effect_available': 'No detailed effect available.',
        'item_effect_en_fallback': 'PokeAPI does not provide this text in English; showing the original language.',
        'items': 'Items',
        ...
        'sources_intro_body': 'Pokepedia is an independent project that brings together factual Pokémon data (species, moves, abilities, items and generations) in one place. It is not affiliated with or endorsed by Nintendo, Game Freak, The Pokémon Company, or Smogon University.',
        ...
        'sources_data_smogon': 'Each Pokémon\'s Smogon tier, as reference data, taken from the public Pokémon Showdown data.',
        ...
        'source_competitive': 'Source: Smogon (via Pokémon Showdown)',
        'tier_title': 'Smogon tier',
        'view_on_pokestudio': 'See sets and strategy on PokeStudio',
        'view_types_on_poketypes': 'Type matchups on PokeTypes',
...
export const itemTranslations: Record<string, Record<string, string>> = {
    ...
    en: {
        ...
        'tera-shard': 'Tera Shards',
        'sandwich-ingredients': 'Sandwich Ingredients',
